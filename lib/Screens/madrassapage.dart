...
// import 'package:masjidi/components/day_selector.dart';
...
// import 'package:masjidi/models/schoolmodel.dart';

// class MadrassaPage extends StatefulWidget {
//   final Map<String, dynamic>? resultData;

//   MadrassaPage({super.key, required this.resultData});
...
//   @override
//   State<MadrassaPage> createState() => _MadrassaPageState();
// }

// class _MadrassaPageState extends State<MadrassaPage> {
//   VoidCallback? refetchQuery; // Store the refetch function
...
//         document: gql(MadrassaPage.getMosqueeWithSchoolQuery),
...
//             employee['role'] == "مدرس القران" || employee['role'] == "مدرس القرآن"
//         ).toList();
...
//               if (index >= schoolDatas.length) {
//       return Center(
//         child: Text('School data not found'),
//       );
//     }
//             final school = schoolDatas[index];
//             final employee = school['employee'];
//             final Students = school['Etudient'];
//             final teacherName = employee != null ? employee['name'] : "Unknown";
//             print("the techers nammmees are: $teacherName");
//             print("the studentssss nammmees are: $Students");
...
//                         child: ExpandableCard(resultData: widget.resultData, schoolData: school,),
//                       ),
//                     ],
//                   ),
//                 ),
...
//       builder: (BuildContext context) => AddEtudiant(schoolId: school['id'].toString(), refetchQuery: () {  },),
//     ),
//   );
//                     },
//                     style: ElevatedButton.styleFrom(
